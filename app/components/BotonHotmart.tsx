...
export default function BotonHotmart({
  ...
  return (
    <a
      ...
      className={`block w-full rounded-lg bg-ember px-5 py-4 text-center font-semibold uppercase text-bg hover:bg-ember-deep ${pulso ? "animate-pulso-cta" : ""} ${className}`}
    >
      {texto}
    </a>
  );
